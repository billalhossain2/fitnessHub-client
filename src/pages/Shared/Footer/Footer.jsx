    ...
    <>
      <footer className="grid xl:grid-cols-4 lg:grid-cols-3 md:grid-cols-2 grid-cols-1 px-3 mt-20 p-3 md:gap-10 gap-16 bg-[#000000] text-white py-10">
        <aside className="space-y-3">
          ...
          <p>
            "FitnessHub: Your ultimate wellness destination. Discover tailored
            workouts, expert tips, and a supportive community. Elevate your
            fitness journey with us—because a healthier, happier you starts
            here."
          </p>
        </aside>
        <nav>
        ...
        <nav>
          ...
          <p className="link link-hover border-b-[1px] pb-1 border-gray-400">
            Fitness Tips
          </p>
          <br />
          <p className="link link-hover border-b-[1px] pb-1 border-gray-400">
